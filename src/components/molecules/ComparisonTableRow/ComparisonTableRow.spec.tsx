...
describe("ComparisonTableRow", () => {
  it("Should match snapshot", () => {
    ...
    const teamComponent = render(
      <ComparisonTableRow team={team} type="team" />
    );
    expect(teamComponent.asFragment()).toMatchSnapshot();

    const averageComponent = render(
      <ComparisonTableRow team={team} type="average" />
    );
    expect(averageComponent).toMatchSnapshot();

    const benchmarkComponent = render(
      <ComparisonTableRow team={team} type="benchmark" />
    );
